...
public class WoodcuttingTrainer implements SkillTrainer {
    ...
    public void trainLowLevelWoodcutting() {
        ...
        GameObject tree = Rs2GameObject.findReachableObject("Tree", true, 10, trees, true, "Chop down");
    ...
    public void trainOakWoodcutting() {
        ...
        GameObject tree = Rs2GameObject.findReachableObject("Oak", true, 10, oaks, true, "Chop down");
        if (tree != null && Rs2GameObject.interact(tree)) {
            Microbot.status = "Woodcutting";
            waitingForAnim = true;
            animWaitStart = System.currentTimeMillis();
    ...
    public void trainWillowWoodcutting() {
        ...
        GameObject tree = Rs2GameObject.findReachableObject("Willow", true, 10, willows, true, "Chop down");
        if (tree != null && Rs2GameObject.interact(tree)) {
            Microbot.status = "Woodcutting";
            waitingForAnim = true;
            animWaitStart = System.currentTimeMillis();
