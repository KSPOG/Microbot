...
import net.runelite.client.plugins.microbot.f2pfishing.enums.Fish;
import net.runelite.client.plugins.microbot.f2pfishing.enums.FishingMethod;
...
public enum F2pFishingFish {
	...
	public int getCoinRestockThreshold() {
		return fish.getCoinRestockThreshold();
	}
